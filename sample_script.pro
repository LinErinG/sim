...
; Coronal source:
sim->add_ellipse, xy_center=[995,-235], fwhm=[15.,15.], intensity=10

; Footpoints:
sim->add_ellipse, xy_center=[923.,-199.], fwhm=[5.,5.], intensity=3
sim->add_ellipse, xy_center=[907.,-265.], fwhm=[5.,5.], intensity=3
